      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <div className="page-links">
            {user.id ? (
              <>
                <Link className="page-links__item" to="/rooms">
                  Начать игру
                </Link>
                <Link className="page-links__item" to="/rules">
                  Правила
                </Link>
                <Link className="page-links__item" to="/leaderboard">
                  Лидерборд
                </Link>
                <Link className="page-links__item" to="/forum">
                  Форум
                </Link>
              </>
            ) : (
              <>
                <Link className="page-links__item" to="/">
                  Об игре
                </Link>
                <Link className="page-links__item" to="/login">
                  Авторизация
                </Link>
                <Link className="page-links__item" to="/registration">
                  Регистрация
                </Link>
              </>
            )}
